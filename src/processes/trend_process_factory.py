...
import argparse
import numpy as np
from processes.trend_process import TrendSurvivalProcess
...
class TrendSurvivalProcessFactory:
    """
    ...
    def __init__(self, args=""):
        ...
        parser.add_argument("-trend", "--trend", dest='trend', 
                            help="trend", 
                            type=float, metavar="trend", required=False, default=None)
        parser.add_argument("-ns", "--noswitch", dest='noswitch', 
                            help="no switch: a2=a1", 
        ...
        logging.log(LOG_DBGINFO, ("\n======================[TrendSurvivalProcessFactory arguments description]=======================\n%s" + 
                                  "\n======================[/TrendSurvivalProcessFactory arguments description]======================") % help_msg)
        
        args = parser.parse_args(args.split())        
        logging.log(LOG_DBGINFO, "[TrendSurvivalProcessFactory] Parsed args: %s" % args)
        self._params = args
    ...
    def yield_processes(self):
        ...
        for _ in range(self._params.n):
            ...
            if self._params.verbose and total_count%100==0:
                logging.info("[TrendSurvivalProcessFactory] %i processes. %.2f switching hazard rate" % 
            ...
            if self._params.noswitch: a2 = a1
                
            if switching_fraction<=self._params.switch_fraction:
                switching_count += 1
                yield TrendSurvivalProcess(max_time=self._params.max_time, 
